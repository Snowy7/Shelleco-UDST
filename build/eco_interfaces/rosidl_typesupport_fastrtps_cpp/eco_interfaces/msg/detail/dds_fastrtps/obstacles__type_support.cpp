...
#include "eco_interfaces/msg/detail/obstacles__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const eco_interfaces::msg::Obstacle &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  eco_interfaces::msg::Obstacle &);
size_t get_serialized_size(
  const eco_interfaces::msg::Obstacle &,
  size_t current_alignment);
size_t
...
cdr_serialize(
  const eco_interfaces::msg::Obstacles & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: obstacles
  {
    ...
    for (size_t i = 0; i < size; i++) {
      eco_interfaces::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  eco_interfaces::msg::Obstacles & ros_message)
{
  // Member: header
  ...
  // Member: obstacles
  {
    ...
    for (size_t i = 0; i < size; i++) {
      eco_interfaces::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: obstacles
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        eco_interfaces::msg::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: obstacles
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        eco_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_Obstacle(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = eco_interfaces::msg::Obstacles;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const eco_interfaces::msg::Obstacles *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<eco_interfaces::msg::Obstacles *>(
    untyped_ros_message);
...
{
  return &eco_interfaces::msg::typesupport_fastrtps_cpp::_Obstacles__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, eco_interfaces, msg, Obstacles)() {
  return &eco_interfaces::msg::typesupport_fastrtps_cpp::_Obstacles__handle;
}
