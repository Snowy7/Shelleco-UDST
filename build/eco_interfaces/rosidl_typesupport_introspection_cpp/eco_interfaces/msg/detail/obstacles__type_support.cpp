...
{
  new (message_memory) eco_interfaces::msg::Obstacles(_init);
}

void Obstacles_fini_function(void * message_memory)
{
  auto typed_message = static_cast<eco_interfaces::msg::Obstacles *>(message_memory);
  typed_message->~Obstacles();
}

size_t size_function__Obstacles__obstacles(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<eco_interfaces::msg::Obstacle> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<eco_interfaces::msg::Obstacle> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<eco_interfaces::msg::Obstacle> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const eco_interfaces::msg::Obstacle *>(
    get_const_function__Obstacles__obstacles(untyped_member, index));
  auto & value = *reinterpret_cast<eco_interfaces::msg::Obstacle *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<eco_interfaces::msg::Obstacle *>(
    get_function__Obstacles__obstacles(untyped_member, index));
  const auto & value = *reinterpret_cast<const eco_interfaces::msg::Obstacle *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Obstacles_message_member_array[2] = {
  {
    ...
    offsetof(eco_interfaces::msg::Obstacles, header),  // bytes offset in struct
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<eco_interfaces::msg::Obstacle>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(eco_interfaces::msg::Obstacles, obstacles),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Obstacles_message_members = {
  ...
  2,  // number of fields
  sizeof(eco_interfaces::msg::Obstacles),
...
get_message_type_support_handle<eco_interfaces::msg::Obstacles>()
{
  return &::eco_interfaces::msg::rosidl_typesupport_introspection_cpp::Obstacles_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, eco_interfaces, msg, Obstacles)() {
  return &::eco_interfaces::msg::rosidl_typesupport_introspection_cpp::Obstacles_message_type_support_handle;
}
